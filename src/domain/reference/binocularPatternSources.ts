...
export const PATTERN_SOURCES: Record<string, string> = {
  ...
  ce: "Duane A. Ann Ophthalmol Otol. 1896 (repr. 1897) — classification of horizontal heterophoria by near/distance relationship and AC/A ratio (calculated/heterophoria method), including a near-esophoria-greater-than-distance pattern associated with a high AC/A ratio. Sheard C. Am J Optom. 1930;7:9–25 — the compensating fusional reserve should be at least twice the phoria. Note: RxKit's own elevated-AC/A finding uses a gradient-method measurement, not the calculated method Duane's classification refers to — no validated gradient AC/A cutoff exists in the literature (Cacho-Martínez et al., J Eye Mov Res, 2026).",
